...
(function() {
    ...
    socket.on('moveVideo', function (data) {
        ...
        if (msg !== "")
            addChatHTML("<div class='chat-movevideo'><span class='timestamp'>[" + (new Date()).toTimeString().split(" ")[0] + "] </span><span class='mv'>" + msg + "</span></div>", 60000);
    })
    ...
    socket.on('queue', function(data) {
        ...
        addChatHTML("<div class='chat-addvideo'><span class='timestamp'>[" + (new Date()).toTimeString().split(" ")[0] + "] </span><span class='av'>" + msg + "</span></div>", 30000);
    });
